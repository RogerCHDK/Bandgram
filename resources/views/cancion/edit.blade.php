            ...
            <div class="row d-md-flex d-lg-flex d-xl-flex justify-content-md-center justify-content-lg-center justify-content-xl-center mb-3">
                <div class="col-lg-7">
                    <div class="p-5"> 
						    ...
						    {!!Form::text('nombre', $cancion->nombre,['placeholder'=>'Ingresa el nombre de la canción','class' => 'form-control form-control-user','type'=>'text','style'=>'font-size: 18px;color: rgb(0,0,0);'])!!}  
							</div>
					     	<div class="form-group row">
							...
							{!!Form::label('genero_id', 'Género Musical: ',['style'=>'font-size: 18px;color: rgb(0,0,0);margin-right: 10px;max-width: 100%;min-width: 100%;']) !!} 
							 {!!Form::select('genero_id', $genero->pluck('nombre','id'),$cancion->genero_id,['placeholder' => 'Genero','class'=>'form-control display-inline-block','style'=>'height: 50px;font-size: 18px;color: rgb(0,0,0);']) !!} 
							 </div>
