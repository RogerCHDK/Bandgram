                ...
                <div class="col-lg-7">
                    <div class="p-5"> 
						...
						{!!Form::label('evento_id', 'Elige el evento: ',['style'=>'font-size: 18px;color: rgb(0,0,0);margin-right: 10px;max-width: 100%;min-width: 100%;']); !!} 
						 {!!Form::select('evento_id', $evento->pluck('nombre_locacion','id'),null,['placeholder' => 'Evento' ,'class'=>'form-control display-inline-block','style'=>'height: 50px;font-size: 18px;color: rgb(0,0,0);']) !!}  
						 </div>
						<div class="form-group row">
						{!!Form::label('precio', 'Precio: ',['style'=>'font-size: 18px;color: rgb(0,0,0);']); !!} 
						{!!Form::number('precio',null,['step'=>'any','placeholder'=>'Ingresa el precio','class'=>'form-control form-control-user','style'=>'font-size: 18px;color: rgb(0,0,0);'])!!}
						</div>
						<div class="form-group row">
						{!!Form::label('stock', 'Stock: ',['style'=>'font-size: 18px;color: rgb(0,0,0);']); !!} 
						{!!Form::number('stock',null,['step'=>'any','placeholder'=>'Ingresa el stock en existencia','class'=>'form-control form-control-user','style'=>'font-size: 18px;color: rgb(0,0,0);'])!!}
						</div>
