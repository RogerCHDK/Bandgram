            ...
            <div class="row d-md-flex d-lg-flex d-xl-flex justify-content-md-center justify-content-lg-center justify-content-xl-center mb-3">
                <div class="col-lg-7">
                    <div class="p-5">
							...
							{!!Form::textarea('descripcion',null,['class'=>'form-control form-control-user','placeholder'=>'Descripción','style'=>'font-size: 18px;color: rgb(0,0,0);height: 160px;'])!!} 
							</div>
							<div class="form-group row">
							{!!Form::label('categoria_id', 'Categoria: ',['style'=>'font-size: 18px;color: rgb(0,0,0);margin-right: 10px;max-width: 100%;min-width: 100%;']); !!} 
							 {!!Form::select('categoria_id', $categoria->pluck('nombre','id'),null,['placeholder' => 'Categoria' ,'class'=>'form-control display-inline-block','style'=>'height: 50px;font-size: 18px;color: rgb(0,0,0);']) !!}  
							 </div>
							<div class="form-group row"> 
							{!!Form::label('stock', 'Ingresa el stock en existencia: ',['style'=>'font-size: 18px;color: rgb(0,0,0);']); !!} 
							{!!Form::number('stock',null,['step'=>'any','placeholder'=>'Stock','class'=>'form-control form-control-user','style'=>'font-size: 18px;color: rgb(0,0,0);'])!!}
							</div>
